  ...
  return (
    <div style={{ background: '#f9fafb', borderRadius: '12px', padding: '16px', border: '1px solid #e5e7eb' }}>
      <p style={{ fontSize: '12px', color: '#6b7280', margin: '0 0 12px' }}>
        Molarity (M) = moles / litres = (mass/MW) / volume
      </p>
...
export default function MolarityPage() {
  return (
    <main style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem 1rem', fontFamily: 'sans-serif' }}>
      ...
      <h1 style={{ fontSize: '24px', fontWeight: '700', color: '#111827', margin: '1rem 0 4px' }}>Molarity calculator</h1>
      <p style={{ fontSize: '13px', color: '#6b7280', marginBottom: '1.5rem' }}>Interconvert between mass, moles, molarity, and volume.</p>
      <MolarityCalc />
    </main>
  )
}